...
#
# These agents need roles/cloudkms.cryptoKeyEncrypterDecrypter to encrypt/decrypt
# data on behalf of Composer, GKE, Pub/Sub, Compute, Artifact Registry, and GCS.
# -----------------------------------------------------------------------------
